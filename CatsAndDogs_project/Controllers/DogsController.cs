...
namespace CatsAndDogs_project.Controllers
{
    public class DogsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Type,Age,Size,Gender,Color,LifeExpectancy,Match,Image")] Dogs dogs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Type,Age,Size,Gender,Color,LifeExpectancy,Match,Image")] Dogs dogs)
        {
            if (id != dogs.Id)
            {
                return NotFound();
