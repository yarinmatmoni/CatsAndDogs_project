...
namespace CatsAndDogs_project.Migrations
{
    ...
    [Migration("20210830134018_guide-cat")]
    partial class guidecat
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CatsAndDogs_project.Models.GuideCat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ImageGuied")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.HasIndex("BreedCat_2Id")
                        .IsUnique();

                    b.ToTable("GuideCat");
                });

            modelBuilder.Entity("CatsAndDogs_project.Models.GuideDog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AvgHeight")
                        .IsRequired()
                        .HasMaxLength(7)
                        .HasColumnType("nvarchar(7)");

                    b.Property<string>("AvgLife")
                        .IsRequired()
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");

                    b.Property<string>("AvgWeight")
                        .IsRequired()
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");

                    b.Property<int>("Breed_2Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CatsAndDogs_project.Models.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CatsAndDogs_project.Models.GuideCat", b =>
                {
                    b.HasOne("CatsAndDogs_project.Models.BreedCat_2", "BreedCat")
                        .WithOne("GuideCat")
                        .HasForeignKey("CatsAndDogs_project.Models.GuideCat", "BreedCat_2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BreedCat");
                });

            modelBuilder.Entity("CatsAndDogs_project.Models.GuideDog", b =>
                {
                    b.HasOne("CatsAndDogs_project.Models.Breed_2", "BreedDog")
                        .WithOne("Guide")
                        .HasForeignKey("CatsAndDogs_project.Models.GuideDog", "Breed_2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BreedDog");
                });
